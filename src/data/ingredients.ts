...
export const nigerianIngredients: IngredientCategory[] = [
  {
    ...
    ingredients: [
      ...
      { id: 'goat-meat', name: 'Goat Meat', category: 'proteins', icon: '🐐', common: true },
      { id: 'turkey', name: 'Turkey', category: 'proteins', icon: '🦃', common: true },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: 'crayfish', name: 'Crayfish (Spice)', category: 'spices-seasonings', icon: '🦐', common: true },

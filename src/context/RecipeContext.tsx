...
import { Recipe as RecipeType, MealPlan, openaiService } from '@/src/services/openai';
...
export function RecipeProvider({ children }: RecipeProviderProps) {
  ...
  const generateRecipes = async () => {
    try {
      ...
      console.log('OpenAI recipes generated successfully');
    } catch (error: any) {
      console.error('Recipe generation error:', error);
      setError(error.message || 'Failed to generate recipes. Please check your OpenAI API key.');
    } finally {
      setLoading(false);
    }
  };
